...
|------------------|---------------------------------------------|----------------|
| `counter_id`     | Counter Internal ID                         | `VARCHAR 15`   |
| `claimant`       | Claimant of the snapshot                    | `VARCHAR 255`  |
| `snapshot_date`  | Date of the snapshot                        | `DATETIME`     |
| `counter_value`  | Counter value at the moment of the snapshot | `BIGINT`       |
