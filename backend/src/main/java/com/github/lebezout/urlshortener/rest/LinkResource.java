...
public class LinkResource {
	...
	public LinkDTO addNewLink(@RequestBody final NewLinkDTO link) {
		Assert.notNull(link, "No data provided");
		Assert.hasText(link.getTarget(), "No target URL provided");
		// create new entity
		LinkEntity entity = new LinkEntity();
		String generatedId = idGenerator.generate(params.getIdLength());
		entity.setId(generatedId);
		entity.setCreator("TODO"); // TODO from LDAP Principal
	...
	public void updateExistingLink(@RequestBody final LinkDTO link) {
		Assert.notNull(link, "No data provided");
	...
	@ResponseStatus(HttpStatus.NO_CONTENT)
	public void deleteExistingLink(@PathVariable("idLink") String idLink) {
		Assert.hasText(idLink, "No ID provided");
